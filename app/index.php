        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-md-6">
              <h1>Tour Caddo Lake!</h1>
              <p>Come tour one of the most scenic and beautiful lakes in the South. Caddo Lake is approximately 26,000 acres of Bald Cypress trees, Spanish moss, abundant wildlife, and scenery that you will never forget. The lake has everything from swamps, bayous and river ways that create a one of a kind experience.</p>
              <p>Book a tour today to see some of the beauty that awaits you.</p>
              <p>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6">
              <div class="img-container">
                <img class="img-responsive" src="images/aerial-2-md.jpg" alt="Aerial view of Caddo Lake" />
              </div>
            </div>
            <div class="col-xs-12 col-sm-6">
              ...
              <p>The names of certain areas of the lake such as Alligator Bayou, Starr Ditch, Ames Spring Basin, Potters Point, Britts Gap and Government Ditch among others give the lake a certain mystic created by the characters from it's past.</p>
              <p>
